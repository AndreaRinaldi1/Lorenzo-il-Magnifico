...
public class IncrementProductionEffectTest {

	private IncrementProductionEffect incP;
	...
	@Before
	public void incrementProductionEffect(){
		incP = new IncrementProductionEffect();
	...
	public void testGetIncrement() {
		incP.setIncrement(increment);
		assertEquals(this.increment, this.incP.getIncrement());
	}
